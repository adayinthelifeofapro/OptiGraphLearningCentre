namespace OptimizelyLearningCentre.Client.Models.Learning;
...
/// <summary>
/// Type of lesson example
/// </summary>
public enum ExampleType
{
    /// <summary>
    /// GraphQL query (Graph course)
    /// </summary>
    Query,

    /// <summary>
    /// AI prompt (Opal course)
    /// </summary>
    Prompt,
...
public class LessonExample
{
    ...
    /// <summary>
    /// The example content (GraphQL query, prompt, code, or configuration)
    /// </summary>
    public string ExampleContent { get; set; } = string.Empty;

    /// <summary>
    /// Type of example (Query, Prompt, Code, Configuration)
    /// </summary>
    public ExampleType Type { get; set; } = ExampleType.Query;

    /// <summary>
    /// Variables for the query (used for GraphQL queries)
    /// </summary>
    ...
    /// <summary>
    /// Sample response for offline demos
    /// </summary>
